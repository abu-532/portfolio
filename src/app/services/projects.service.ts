  ...
  private readonly projects: Project[] = [
    {
      ...
      techStack: ['Angular 15', 'Angular Material', 'Bootstrap', 'TypeScript', 'REST APIs'],
    ...
    },
    {
      ...
      contributions: [
        ...
        'Added contact form and project showcase',
      ],
    ...
    },
    {
      ...
      techStack: ['Node.js', 'NestJS', 'MongoDB', 'Mongoose', 'JWT', 'Bcrypt'],
    ...
    },
    {
      ...
      description:
        'Responsive corporate website developed to showcase company services, business information, and customer engagement across all devices.',
      contributions: [
      ...
      techStack: ['Angular', 'Bootstrap', 'Angular Material', 'Git'],
    ...
    },
    {
      ...
      techStack: ['Angular 17', 'Tailwind CSS'],
